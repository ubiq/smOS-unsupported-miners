...
cd
whiptail --msgbox 'Go to http://simplemining.net and setup a new rig group for ethminer-v0.15.0 that now supports ProgPoW. --backtitle "ProgPow" --title "ProgPow" 15
55
clear
echo "                                                                           
                             /######,                                          
